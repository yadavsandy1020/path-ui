...
<div class="row p-1">
  <div class="mb-3 col-lg-3">
    <label for="patientName" class="form-label font-weight-bold"
      >Patient Name</label
    >
    <input
      type="text"
  ...
  <div class="mb-3 col-lg-3">
    <label for="patientAge" class="form-label font-weight-bold"
      >Patient Age</label
    >
    <input
      type="number"
  ...
  <div class="mb-3 col-lg-3">
    ...
    >
      <option value={0} selected disabled>Select M/F</option>
      <option value="M">Male</option>
      <option value="F">Female</option>
    </select>
  </div>
  <div class="mb-3 col-lg-3">
    <label for="doctorName" class="form-label font-weight-bold"
      >Referred By</label
    >
...
<span class="badge badge-dark text-bg-light p-3"
  >Haematological Investigation</span
>
<div class="row p-lg-1">
  <div class="mb-3 col-lg-3">
    <label for="haemogloabin" class="form-label font-weight-bold"
      >Hemoglobin (Cyanmeth Method)</label
    >
    <input
      type="text"
      class="form-control"
      id="haemogloabin"
      bind:value={haemoglobin}
    />
    <div id="haemogloabinHelp" class="form-text">12.0-18.0 Gm. %</div>
  </div>
  ...
  <div class="mb-3 col-lg-3">
    ...
    <div id="totalRbcHelp" class="form-text">4.5-6.5 Million/Cmm</div>
  </div>

  <div class="mb-3 col-lg-3">
    <label for="totalWbc" class="form-label font-weight-bold"
      >Total WBC (Differential Method)</label
    >
    <input type="text" class="form-control" id="totalWbc" bind:value={wbc} />
    <div id="totalWbcHelp" class="form-text">4000-11000/Cmm</div>
  </div>

  <div class="mb-3 col-lg-3">
    <label for="neutrophils" class="form-label font-weight-bold"
      >Neutrophils</label
    >
    <input
      type="text"
      class="form-control"
      id="neutrophils"
      bind:value={neutrophils}
    />
    <div id="neutrophilsHelp" class="form-text">55-65%</div>
  </div>

  <div class="mb-3 col-lg-3">
    <label for="lymphocytes" class="form-label font-weight-bold"
      >Lymphocytes</label
    >
    <input
      type="text"
      class="form-control"
      id="lymphocytes"
      bind:value={lymphocytes}
    />
    <div id="lymphocytesHelp" class="form-text">30-35%</div>
  </div>

  <div class="mb-3 col-lg-3">
    <label for="eosinophils" class="form-label font-weight-bold"
      >Eosinophils</label
    >
    <input
      type="text"
      class="form-control"
      id="eosinophils"
      bind:value={eosinophils}
    />
    <div id="eosinophilsHelp" class="form-text">1-6%</div>
  </div>
  ...
  <div class="mb-3 col-lg-3">
    ...
    <input
      ...
      class="form-control"
      id="monocytes"
      bind:value={monocytes}
    />
    <div id="monocytesHelp" class="form-text">1-5%</div>
  </div>
  ...
  <div class="mb-3 col-lg-3">
    ...
    <input
      ...
      class="form-control"
      id="platelets"
      bind:value={platelets}
    />
    <div id="plateletsHelp" class="form-text">1,50,000-4,50,000/Cmm</div>
  </div>
</div>
  ...
  <div class="row p-lg-1">
    <div class="mb-3 col-lg-3">
      ...
      <select
        class="form-control"
        id="styphiO"
        bind:value={widalFields.styphiO}
      >
    ...
    <div class="mb-3 col-lg-3">
      ...
      <select
        class="form-control"
        id="styphiH"
        bind:value={widalFields.styphiH}
      >
        <option value={0} selected disabled>Select Value</option>
        <option value={80}>80</option>
        <option value={160}>160</option>
    ...
    <div class="mb-3 col-lg-3">
      <label for="sParaTyphiAH" class="form-label font-weight-bold"
        >S. Para Typhi A H</label
      >
      <select
        class="form-control"
        id="sParaTyphiAH"
        bind:value={widalFields.sParaTyphiAH}
      >
        <option value={0} selected disabled>Select Value</option>
        <option value={80}>80</option>
        <option value={160}>160</option>
    ...
    <div class="mb-3 col-lg-3">
      <label for="sParaTyphiBH" class="form-label font-weight-bold"
        >S. Para Typhi B H</label
      >
      <select
        class="form-control"
        id="sParaTyphiBH"
        bind:value={widalFields.sParaTyphiBH}
      >
        <option value={0} selected disabled>Select Value</option>
        <option value={80}>80</option>
        <option value={160}>160</option>
...
{#if showEsr}
  <div class="row p-lg-1">
    <div class="mb-3 col-lg-3">
      ...
      <div id="plateletsHelp" class="form-text">0-20 mm/hr</div>
    </div>
  </div>
{/if}

<div class="mb-3 col-lg-3 text-center">
  <button type="submit" class="btn btn-primary p-2 m-2" on:click={handleSubmit}
    >Submit</button
  >
  <button type="reset" class="btn btn-secondary p-2 m-2" on:click={handleReset}
    >Reset</button
  >
  <button type="button" class="btn btn-danger p-2 m-2" on:click={handleCancel}
    >Cancel</button
  >
</div>
